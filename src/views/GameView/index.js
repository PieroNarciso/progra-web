...
const GameView = () => {
  return /*html*/ `
    <div class="grid grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1 h-full overflow-hidden gs5:grid-cols-2 gs5:grid-rows-1">
      <div class ="gs5:col-start-1 md:col-start-1 row-start-1 flex flex-wrap w-full">
        <!-- IMAGEN TRAGAMONEDAS -->
        <div class="relative z-0 grid grid-rows-5 w-full h-full items-center justify-center">
          <img class="gs5:h-4/5 md:h-3/5 h-4/5 row-start-1 row-end-6" src="maq-celeste.png">
        </div>
        <!-- DIV CON ELEMENTOS DE LA MAQ -->
        <div id= 'maq_celeste_Mov' class="gs5:-mt-12 gs5:w-1/2 gs5:h-full md:-mt-12 md:w-1/2 md:h-full absolute z-10 grid grid-rows-5 grid-cols-1 w-full h-1/2 items-center justify-items-center">
          <!-- NOMBRE DE LA MAQUINA Y MENSAJE -->
          <div class="nomMaquina1 flex flex-col justify-start gs5:mt-32 gs5:mb-10 md:mt-32 md:-mb-3">
          ...
          <!-- IMAGEN -->
          <div id="imgePirata" class="md:mt-80 z-10 row-start-1 mt-14 ml-1 gs5:mt-36">
            <img class="md:h-16 md:mt-4 h-10 gs5:mt-4" src="pirata.png">
          </div>
          <!-- CANTIDAD A APOSTAR Y GANANCIA EN PANTALLA -->
          <div class="md:w-64 md:mt-52 flex row-start-3 mb-1 row-end-4 w-40 mt-16 justify-evenly gs5:mt-36">
          ...
          <!-- LETRAS -->
          <div class="md:-mt-72 md:w-60 md:pt-5 flex justify-around mb-72 row-start-5 w-36 gs5:mt-10">
      ...
      <div class="gs5:col-start-2 gs5:row-start-1 md:col-start-2 md:row-start-1 row-start-2 flex flex-wrap z-30">
        <!-- IMAGEN TRAGAMONEDAS -->
        <div class="relative z-0 grid grid-rows-5 w-full h-full items-center justify-center">
          <img  class="gs5:h-4/5 md:h-3/5 h-4/5 row-start-1 row-end-6" src="maq-rosa.png" >
        </div>
        <!-- DIV CON ELEMENTOS DE LA MAQ -->
        <div id ='maq_rosa_Mov' class="gs5:-mt-12 gs5:w-1/2 md:-mt-12 md:w-1/2 md:h-full absolute bottom-0 z-10 grid grid-rows-5 grid-cols-1 w-full h-1/2 items-center justify-items-center">
          <!-- NOMBRE DE LA MAQUINA Y MENSAJE -->
          <div class="gs5:mt-0 gs5:mb-72 md:mt-52 md:-mb-3 nomMaquina2 flex flex-col justify-start z-20 h-24">
          ...
          <!-- IMAGEN -->
          <div id="imgeEgip" class="gs5:mb-64 md:mt-12 z-10 row-start-2 mb-7 ml-1">
            <img class="md:h-16 md:mt-4 h-11" src="Egipto.png">
          </div>
          <!-- CANTIDAD A APOSTAR Y GANANCIA EN PANTALLA -->
          <div class="gs5:mb-38 gs5:-mt-10 md:w-64 md:mt-52 md:mb-4 flex row-start-3 row-end-4 w-40 mt-28 mb-2 justify-evenly">
          ...
          <!-- BOTONES -->
          <div class="gs5:-mt-16 md:-mt-1 md:w-72 md:items-center mt-11 flex row-start-4 row-end-5 w-40 h-3/5 justify-around">
          ...
          <!-- LETRAS -->
          <div class="gs5:-mt-10 md:-mt-80 md:mb-68 md:w-60 md:pb-1 flex justify-around mb-60 row-start-5 w-36">
