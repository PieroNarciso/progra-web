import { GameViewEvents } from "../../views/GameView";
...
<body class="bg-gray-500">
  ...
  <div class="bg-black bg-opacity-50 absolute inset-0 flex justify-center items-center " id="overlay">
    <div class="bg-gray-100 rounded shadow-xl py-1 px-4 w-full h-full border-black border-4">
      <div class="flex justify-between items-center">
        <h4 class="text-lg font-bold">Instrucciones </h4>
        <svg class="w-5 h-4 cursor-pointer hover:bg-gray-300" id="closemodal" 
        ...
        <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-2  my-auto pt-0 lg:pt-10">
        <!--Card 1-->
      ...
      <div class="px-5 py-4">
        ...
        Cuando se apuesta a una dame  máquina, ella responde con 2 letras.
        </p>
      </div>
      <div class="px-6 pt-4 pb-2">
    ...
    <div class="rounded overflow-hidden shadow-lg">
      ...
      <div class="px-6 py-4">
        ...
        <p class="text-gray-700 text-base">
        Si sale JJ, se duplica, si es QQ se triplica, si es KK es diez veces lo apostado. Si sale cualquier otra combinación se pierde lo apostado.
        </p>
...
export const InstruccionesViewEvents =(viewElement) =>{
  let overlay = viewElement.querySelector('#overlay')
  let aceptarbg = viewElement.querySelector('#aceptarbg')
  let close=viewElement.querySelector('#closemodal')
  let Aceptar=viewElement.querySelector("#Aceptar")
function  Aparecer(){
